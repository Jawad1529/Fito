...
// One doc per referred user (not per consultation) — created the first time
// a referred signup submits a consultation (see consultations.controller.js),
// then managed entirely by admins from here on (amount/status/proof are all
// admin-entered, there's no automatic commission calculation).
const referralCommissionSchema = new mongoose.Schema(
    {
        ...
        // The consultation that first triggered this record — kept for admin
        // context only, not re-checked on subsequent consultations.
