...
export default function ProductManagementPage() {
    ...
    const columns = [
        ...
        { title: 'Price', dataIndex: 'price', sorter: (a, b) => a.price - b.price, render: (p) => `$${p.toFixed(2)}` },
        { title: 'Stock', dataIndex: 'stock', sorter: (a, b) => a.stock - b.stock },
        { title: 'Rating', dataIndex: 'rating', render: (r) => <RatingStars rating={r} /> },
        {
            title: 'Status',
            dataIndex: 'status',
            filters: [
                ...
                {viewing && (
                    <div>
                        ...
                        <Descriptions column={1} bordered size="small">
                            ...
                            <Descriptions.Item label="Rating"><RatingStars rating={viewing.rating} /> ({viewing.reviews} reviews)</Descriptions.Item>
